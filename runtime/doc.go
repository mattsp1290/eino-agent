...
// current user's ordered typed content blocks to the provider snapshot, and
// atomically persists that user message and its parts before provider execution. Callers must not resend history
