...
func DefaultSummaryPolicy() SummaryPolicy {
	return SummaryPolicy{
		...
		ForbiddenInputs: []string{
			...
			"encrypted_reasoning",
			"provider_state",
			"provider_state_base64",
			"provider_state_digest",
			"provider_state_restore_error",
			"compaction_summary",
...
func DefaultFields() []FieldPolicy {
	return []FieldPolicy{
		...
		{Name: "provider_state", Class: FieldForbidden, Notes: "Never export provider-private continuity bytes."},
		{Name: "provider_state_base64", Class: FieldForbidden, Notes: "Never export the durable base64 representation of provider-private state."},
		{Name: "provider_state_digest", Class: FieldForbidden, Notes: "Never derive or export a digest from provider-private state."},
		{Name: "provider_state_restore_error", Class: FieldForbidden, Notes: "Never export raw codec or decoder errors that may contain provider-private state."},
